function [minRodLength] = PS08_fin_length_koike(thermalConductivity, minRodDiameter, maxRodDiameter)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% ENGR 132 
% Program Description 
...
elseif invalidThermalConductivity
    ...
    for rodDiameter = minRodDiameter:0.5:maxRodDiameter
        ...
        while round(tempX) ~= ambientTemp
            ...
            fprintf("The temperature of a %f diameter rod x(m) from the heat source is %.0f K\n", rodDiameter, tempX);     
        end
    end
minRodLength = x;
end   
