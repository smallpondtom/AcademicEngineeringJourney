% AAE 567 Final Exam Spring 2021 Problem 2 Part (ii)
% Tomoki Koike
...
% Initialize the value we are looking for
res = {}; 
...
for n = 0:10
    ...
    [xhat{n+2}, Q{n+2}, res{n+1}] = dkf(A{n+1}, B{n+1}, C{n+1}, D{n+1}, ...
                                            Q{n+1}, xhat{n+1}, y{n+1});
end
%%
function [Xnew, Qnew, XX] = dkf(Ad, Bd, Cd, Dd, Qd, xhat, y)
