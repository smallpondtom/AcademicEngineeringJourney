...
# AUTHOR: Tomoki Koike
# DATE: OCT. 27 2019
# DESCRIPTION: This program is designed to execute the class functions in the file
#              employee_classes.py and execute each of the functions to make sure
#              that they are working fine.
###

# Importing the module
import employee_classes as empC
